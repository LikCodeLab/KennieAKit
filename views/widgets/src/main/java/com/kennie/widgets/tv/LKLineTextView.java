...
/**
 * project : KennieViews
 * class_name :  LKLineTextView
 * author : Kennie
 * date : 2021/11/18 0:13
 * desc : 带线条的TextView
 */
public class LKLineTextView extends AppCompatTextView {
    ...
    public LKLineTextView(Context context) {
        this(context, null);
    }

    public LKLineTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LKLineTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.LKLineTextView);
        mLineSize = ta.getDimensionPixelSize(R.styleable.LKLineTextView_ltv_line_size, 0);
        if ((mSetLineColor = ta.hasValue(R.styleable.LKLineTextView_ltv_line_color))) {
            mLineColor = ta.getColor(R.styleable.LKLineTextView_ltv_line_color, Color.BLACK);
        }
        mLineInterval = ta.getDimensionPixelSize(R.styleable.LKLineTextView_ltv_line_interval, 0);
        int startStyle = ta.getInt(R.styleable.LKLineTextView_ltv_line_style, mLineStyle.style);
