...
/**
 * project : KennieViews
 * class_name :  LKClearEditText
 * author : Kennie
 * date : 2021/11/18 0:13
 * desc : 带清除按钮的EditText
 */
public final class LKClearEditText extends AppCompatEditText
    ...
    public LKClearEditText(Context context) {
        this(context, null);
    }

    public LKClearEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    @SuppressWarnings("all")
    public LKClearEditText(Context context, AttributeSet attrs, int defStyleAttr) {
