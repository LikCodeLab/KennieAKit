...
/**
 * project : KennieViews
 * class_name :  LKSlantedTextView
 * author : Kennie
 * date : 2021/11/18 0:13
 * desc : 倾斜的TextView(方向：左上左下右上右下角)
 */
public class LKSlantedTextView extends View {
    ...
    public LKSlantedTextView(Context context) {
        this(context, null);
    }

    public LKSlantedTextView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public LKSlantedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LKSlantedTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init(attrs);
    }

    public void init(AttributeSet attrs) {
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.LKSlantedTextView);

        mTextSize = array.getDimension(R.styleable.LKSlantedTextView_slantedTextSize, mTextSize);
        mTextColor = array.getColor(R.styleable.LKSlantedTextView_slantedTextColor, mTextColor);
        mSlantedLength = array.getDimension(R.styleable.LKSlantedTextView_slantedLength, mSlantedLength);
        mSlantedBackgroundColor = array.getColor(R.styleable.LKSlantedTextView_slantedBackgroundColor, mSlantedBackgroundColor);

        if (array.hasValue(R.styleable.LKSlantedTextView_slantedText)) {
            mSlantedText = array.getString(R.styleable.LKSlantedTextView_slantedText);
        }

        if (array.hasValue(R.styleable.LKSlantedTextView_slantedMode)) {
            mMode = array.getInt(R.styleable.LKSlantedTextView_slantedMode, 0);
        }
        array.recycle();
    ...
    public LKSlantedTextView setText(String str) {
        mSlantedText = str;
        postInvalidate();
        return this;
    }

    public LKSlantedTextView setText(int res) {
    ...
    public LKSlantedTextView setSlantedBackgroundColor(int color) {
    ...
    public LKSlantedTextView setTextColor(int color) {
        mTextColor = color;
        mTextPaint.setColor(mTextColor);
        postInvalidate();
        return this;
     ...
     * @return this
     */
    public LKSlantedTextView setMode(int mode) {
    ...
    public LKSlantedTextView setTextSize(int size) {
        this.mTextSize = size;
        mTextPaint.setTextSize(mTextSize);
        postInvalidate();
        return this;
     ...
     * @return this
     */
    public LKSlantedTextView setSlantedLength(int length) {
