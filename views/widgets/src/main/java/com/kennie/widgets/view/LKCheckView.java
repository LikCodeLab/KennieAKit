...
/**
 * project : KennieViews
 * class_name :  LKCheckView
 * author : Kennie
 * date : 2021/11/18 0:13
 * desc : 带动画效果的CheckBox选择框(圆形、方形)
 */
public class LKCheckView extends View implements Checkable {
    ...
    public LKCheckView(Context context) {
        this(context, null);
    }

    public LKCheckView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LKCheckView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.LKCheckView);

        mode = typedArray.getInt(R.styleable.LKCheckView_cv_mode, CheckVewMode.CIRCLE.mode);

        enableBg = typedArray.getBoolean(R.styleable.LKCheckView_cv_enable_bg, Boolean.FALSE);
        bgNormalColor = typedArray.getColor(R.styleable.LKCheckView_cv_bg_normal_color, getColor(R.color.check_view_bg_normal_color));
        bgCheckedColor = typedArray.getColor(R.styleable.LKCheckView_cv_bg_checked_color, getColor(R.color.check_view_bg_checked_color));

        enableBorder = typedArray.getBoolean(R.styleable.LKCheckView_cv_enable_border, Boolean.TRUE);
        borderNormalColor = typedArray.getColor(R.styleable.LKCheckView_cv_border_normal_color, getColor(R.color.check_view_border_normal_color));
        borderCheckedColor = typedArray.getColor(R.styleable.LKCheckView_cv_border_checked_color, getColor(R.color.check_view_border_checked_color));

        tickColor = typedArray.getColor(R.styleable.LKCheckView_cv_tick_color, getColor(R.color.check_view_tick_color));
        strokeWidth = typedArray.getDimensionPixelSize(R.styleable.LKCheckView_cv_stroke_width, 5);
        corner = typedArray.getDimensionPixelSize(R.styleable.LKCheckView_cv_corner, 5);
        animDuration = typedArray.getInt(R.styleable.LKCheckView_cv_duration, 150);
    ...
    public interface OnCheckedChangeListener {
        ...
        void onCheckedChanged(LKCheckView LKCheckView, boolean isChecked);
    }
