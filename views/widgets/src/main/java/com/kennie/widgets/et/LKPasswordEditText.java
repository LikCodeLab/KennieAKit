...
/**
 * project : KennieViews
 * class_name :  LKPasswordEditText
 * author : Kennie
 * date : 2021/11/18 0:13
 * desc : 密码隐藏显示EditText
 */
public final class LKPasswordEditText extends AppCompatEditText
    ...
    public LKPasswordEditText(Context context) {
        this(context, null);
    }

    public LKPasswordEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    @SuppressWarnings("all")
    public LKPasswordEditText(Context context, AttributeSet attrs, int defStyleAttr) {
