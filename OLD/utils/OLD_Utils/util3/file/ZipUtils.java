package cn.lukas.utils.core.old.file;
...
/**
 * https://github.com/ticksj/Android_BaseUtils
 */
public class ZipUtils {
    ...
    public static void UnZipFolder(String zipFileString, String outPathString) throws Exception {
        ZipFile zipFile = new ZipFile(zipFileString, Charset.forName("GBK"));
//        zipFile.getInputStream(zipFile.entries())
