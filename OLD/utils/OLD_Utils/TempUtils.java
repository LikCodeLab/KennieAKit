package com.kennie.android.library.utils.OLD;
...
import com.kennie.android.library.utils.KBaseUtils;
...
public class TempUtils {
    ...
    public static int getNetWorkType() {
        ...
        ConnectivityManager cm = (ConnectivityManager) KBaseUtils.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
...
//            Log.d("----result---", "result = " + result);
    ...
    public static boolean isWorked(String servicePath) {
        ActivityManager myManager = (ActivityManager) KBaseUtils.getContext().getApplicationContext().getSystemService(
    ...
    private static boolean existPackageName(String packageName) {
        PackageManager packageManager = KBaseUtils.getContext().getPackageManager();
    ...
    public static void openApk(String packName) {
        if (existPackageName(packName)) {
            ...
            KBaseUtils.getContext().startActivity(intent);
    ...
    private static Intent getAppOpenIntentByPackageName(String packageName) {
        String mainAct = null;
        PackageManager pkgMag = KBaseUtils.getContext().getPackageManager();
    ...
    public static int getAppVersionCode() {
        String pName = KBaseUtils.getContext().getPackageName();
        int versionCode = 0;

        try {
            PackageInfo pinfo = KBaseUtils.getContext().getPackageManager().getPackageInfo(
