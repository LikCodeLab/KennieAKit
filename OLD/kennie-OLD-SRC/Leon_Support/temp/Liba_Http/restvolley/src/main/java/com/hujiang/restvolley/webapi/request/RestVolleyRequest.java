...
public abstract class RestVolleyRequest<R extends RestVolleyRequest> {
    ...
    /**
     * request priority {@link Request.Priority}, default is {@link Request.Priority#NORMAL}.
     */
