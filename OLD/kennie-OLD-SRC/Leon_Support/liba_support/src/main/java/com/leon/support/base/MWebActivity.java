...
import com.leon.support.base.framework.fragment.MWebFragment;
...
public class MWebActivity extends MToolBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null == fragment) {
            ...
            fm.beginTransaction().add(R.id.base_content, fragment, TAG_FRAGMENT).commit();
        }
    ...
    protected View onCreateView() {
        return getLayoutInflater().inflate(R.layout.base_fragment_activity, null, true);
    }
