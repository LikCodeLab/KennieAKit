...
import com.leon.support.base.framework.adapter.AbsAdapter;
import com.leon.support.base.framework.adapter.HolderAdapter;
...
public abstract class MListFragment<T> extends MFragment implements IItemCreator<View, T> {
    ...
    protected View onCreateListView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.base_listview, null);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mListView = (ListView) view.findViewById(R.id.base_listview);
        if (null == mListView) {
