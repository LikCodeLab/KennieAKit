...
import com.leon.support.base.MConstants;
...
public class LoadingDialogFragment extends BaseDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.base_dialog_loading, null);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (null != arguments) {
            final String message = arguments.getString(MConstants.Extras.DATA);
...
//    }
    ...
    public LoadingDialogFragment setMessage(String message) {
        if (isAdded() && null != mMessageText) {
            ...
            bundle.putString(MConstants.Extras.DATA, message);
            setArguments(bundle);
        }
        return this;
    }
