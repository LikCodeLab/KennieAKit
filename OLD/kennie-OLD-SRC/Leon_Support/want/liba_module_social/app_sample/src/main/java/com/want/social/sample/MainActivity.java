package com.want.social.sample;
...
import com.want.social.SocialAgent;
import com.want.social.impl.weixin.WXParams;
import com.want.social.platform.IPlatform;
import com.want.social.shareable.IShareParams;
    ...
    private class WXTextImage {
        void shareTextImage(String title, String description, String path) {
            SocialAgent.newInstance()
                       ...
                       .shareActionListener(new ShareActionListener() {})
                       .shareParams(new WXParams()
                                            .type(IShareParams.Type.TEXT_IMAGE)
                                            .title(title)
                                            .text(description)
                                            .imagePath(path))
                       .share();
    ...
    private class WXWebpage {
        void shareWebpage(String title, String text, String path, String url) {
            SocialAgent.newInstance()
                       ...
                       .shareActionListener(new ShareActionListener() {})
                       .shareParams(new WXParams()
                                            .type(IShareParams.Type.WEBPAGE)
                                            .title(title)
                                            .text(text)
                                            .imagePath(path)
                                            .url(url))
