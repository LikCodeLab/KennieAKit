package com.leon.social.agent.ui;
...
import com.leon.social.agent.IPlatformProxy;
import com.leon.social.agent.R;
import com.leon.social.agent.ShareHelper;
import com.leon.social.agent.databinding.SocialDialogItemLayoutBinding;
import com.leon.social.agent.databinding.SocialDialogLayoutBinding;
...
public class SocialDialog extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        Dialog dialog = new Dialog(getActivity(), R.style.Social_Gravity);
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            final SocialDialogItemLayoutBinding binding =
                    DataBindingUtil.inflate(inflater, R.layout.social_dialog_item_layout, null, true);
