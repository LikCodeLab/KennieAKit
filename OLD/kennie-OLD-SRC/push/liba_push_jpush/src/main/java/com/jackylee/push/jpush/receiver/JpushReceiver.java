package com.jackylee.push.jpush.receiver;
...
import com.jackylee.log.lg;
import com.jackylee.push.core.IPushAgent;
import com.jackylee.push.core.LogHelper;
import com.jackylee.push.jpush.localbroadcast.MBroadcastReceiver;

import cn.jpush.android.api.JPushInterface;

import static com.jackylee.push.core.IPushAgent.PUSH_DATA;
import static com.jackylee.push.core.PushSender.sendPush;

/**
 * <b>Project:</b> liba_push_jpush<br>
 * <b>Create Date:</b> 16/9/19<br>
 * <b>Author:</b> JackyLee<br>
 * <b>Description:</b>
 *
 * <br>
 */
...
//            lg.v(LogHelper.TAG, formatMessage("extras: " + lg.getString(extras)));
        ...
        extras.putString(Constants.Extras.TAG, IPushAgent.AGENT_JPUSH);
    ...
    private void innerHandleRegistration(Context context, String id) {
        ...
        bundle.putString(IPushAgent.PUSH_DATA, id);
