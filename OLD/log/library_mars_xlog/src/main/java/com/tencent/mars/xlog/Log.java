...
public class Log {
    ...
    public interface LogImp {
        ...
        void logV(long logInstancePtr, String tag, String filename, String fun_cname, int linuxTid, int pid, long tid, long main_tid, String log);

        void logI(long logInstancePtr, String tag, String filename, String fun_cname, int linuxTid, int pid, long tid, long main_tid, String log);

        void logD(long logInstancePtr, String tag, String filename, String fun_cname, int linuxTid, int pid, long tid, long main_tid, String log);

        void logW(long logInstancePtr, String tag, String filename, String fun_cname, int linuxTid, int pid, long tid, long main_tid, String log);

        void logE(long logInstancePtr, String tag, String filename, String fun_cname, int linuxTid, int pid, long tid, long main_tid, String log);

        void logF(long logInstancePtr, String tag, String filename, String fun_cname, int linuxTid, int pid, long tid, long main_tid, String log);

        int getLogLevel(long logInstancePtr);

        void setAppenderMode(long logInstancePtr, int mode);

        long openLogInstance(int level, int mode, String cacheDir, String logDir, String name_prefix, int cacheDays);

        long getXlogInstance(String name_prefix);

        void releaseXlogInstance(String name_prefix);

        void appenderOpen(int level, int mode, String cacheDir, String logDir, String name_prefix, int cacheDays);
    ...
    private static LogImp debugLog = new LogImp() {
        ...
        @Override
        public void logF(long logInstancePtr, String tag, String filename, String fun_cname, int line, int pid, long tid, long main_tid, final String log) {
        ...
        @Override
        public long getXlogInstance(String name_prefix) {
            return 0;
        }

        @Override
        public void releaseXlogInstance(String name_prefix) {
    ...
    public static void appenderOpen(int level, int mode, String cacheDir, String logDir, String name_prefix, int cacheDays) {
        if (logImp != null) {
            logImp.appenderOpen(level, mode, cacheDir, logDir, name_prefix, cacheDays);
        }
    }
