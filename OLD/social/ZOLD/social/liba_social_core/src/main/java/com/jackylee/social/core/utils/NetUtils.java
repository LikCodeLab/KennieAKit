package com.jackylee.social.core.utils;


import com.jackylee.log.lg;
import com.jackylee.social.core.SocialConstants;
...
public class NetUtils implements SocialConstants {
    ...
    public static File downloadImage(String url) {
        try {
            ...
            if (DEBUG) {
                lg.v(TAG, "download image success. file path: " + file.getAbsolutePath() + ", url: " + url);
            }
            return file;
        } catch (IOException e) {
            e.printStackTrace();
            lg.w(TAG, "download image error, url: " + url);
        }
