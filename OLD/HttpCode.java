...
public class HttpCode {
    ...
    public static class HTTP {
         ...
         * 请求接口尚未实现
         */
        public static final int UM_IMPLEMENTS = 501;
        /**
         * 网关错误
         */
         ...
         * http 协议版本不支持
         */
        public static final int HTTP_VERSION_UN_SUPPORT = 505;

    }


    /**
     * 请求返回成功后，框架层处理错误.避免与服务端定义错误重复使用
     */
    public static class CODE {
        ...
        //解析参数错误
        public static final int SHELL_FORMAT_ERROR = 1007;
        //未知主机
