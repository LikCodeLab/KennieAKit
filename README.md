...
<p align="center">
    <strong>KennieAKit 模板库</strong>
    <br>
    <a href="https://kennielab.github.io/KennieAKit/">使用文档</a>
    <br>
</p>
...
如有任何疑问或者Bug，请在 github 上公开讨论[技术问题](https://github.com/kennielab/KennieAKit/issues)
...
## 开始使用
因为依赖的关系，KennieAKit 目前仅支持 AndroidX 作为基础进行开发，若您正在使用最新版本的 Android Studio，那么默认创建的项目就是使用 AndroidX 作为底层框架的。
...
Latest Version：[![](https://jitpack.io/v/kennielab/KennieAKit.svg)](https://jitpack.io/#kennielab/KennieAKit)
...
```
def lib = "0.0.2"
implementation "com.github.kennielab:KennieAKit:${lib}"
```

### Wiki使用

具体的使用说明，请参阅 [DOC](https://kennielab.github.io/KennieAKit/)
